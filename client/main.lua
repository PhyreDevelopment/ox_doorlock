...
-- local doorsToFix = {
--     -- hashes das portas mais chatas
--     -131296141,    -- v_ilev_bank4door
--     -1215222675,   -- vault
--     631614199,     -- teller door
--     -- Adicione os que você tem problema
-- }

-- Citizen.CreateThread(function()
--     while true do
--         Citizen.Wait(5000) -- roda a cada 5 segundos para garantir

--         local playerCoords = GetEntityCoords(PlayerPedId())
--         for _, doorHash in ipairs(doorsToFix) do
--             local doorObj = GetClosestObjectOfType(playerCoords, 50.0, doorHash, false, false, false)
--             if DoesEntityExist(doorObj) then
--                 local doorId = AddDoorToSystem(doorHash, doorObj, GetEntityCoords(doorObj), false, false, false)
--                 DoorSystemSetAutomaticDistance(doorId, 5.0, false)
--                 -- Porta desbloqueada/automática
